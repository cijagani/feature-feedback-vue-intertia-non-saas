...
import { MdFullscreen } from "@kalimahapps/vue-icons";
import { MdFullscreenExit } from "@kalimahapps/vue-icons";
import { ClSave } from "@kalimahapps/vue-icons";
import { LuRefreshCw } from "@kalimahapps/vue-icons";
import { BsMenuButtonFill } from "@kalimahapps/vue-icons";
import { FlLink } from "@kalimahapps/vue-icons";
import { FlFilledLightbulbFilament } from "@kalimahapps/vue-icons";
import { FlFilledContactCard } from "@kalimahapps/vue-icons";
import { CaLocationPersonFilled } from "@kalimahapps/vue-icons";
import { MdOutlinedPermMedia } from "@kalimahapps/vue-icons";
import { CdChecklist } from "@kalimahapps/vue-icons";
...
var initialNodes = ref([
    {
        ...
        data: {
            output: [
                {
                    // Change to match WhatsBot's output array pattern
                    reply_type_text: "",
                    reply_type: "",
                    rel_type: "",
                    trigger: "",
...
function addNodeAtPosition(type, position) {
    const newNodeId = Date.now().toString(); // Use simple numeric IDs like WhatsBot
    ...
    switch (type) {
        case "textMessage":
            ...
            break;
        case "buttonMessage": // Change to buttonsMessage to match WhatsBot
            nodeData = {
                output: [
                    {
                        reply_text: "",
    ...
    // Add the node with WhatsBot structure
    addNodes([
        {
            id: newNodeId,
            type: type === "buttonMessage" ? "buttonMessage" : type, // Map to WhatsBot naming
            data: nodeData,
            position,
            initialized: false,
        },
