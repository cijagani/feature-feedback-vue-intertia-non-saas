                    ...
                    <div class="sections-container">
                        ...
                        >
                            ...
                            <input
                                ...
                                @input="updateNodeData"
                                class="mb-3 block w-full rounded-md border-gray-300 bg-white px-3 py-2 text-sm shadow-sm focus:border-teal-500 focus:ring focus:ring-teal-200 focus:ring-opacity-50 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200"
                                :class="{
                                    'border-danger-300 dark:border-danger-700':
                                        !sectionValidations[sectionIndex]
                                            .titleValid,
