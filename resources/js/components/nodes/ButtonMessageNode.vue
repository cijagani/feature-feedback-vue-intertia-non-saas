...
function updateNodeData() {
    // Update the output in WhatsBot format
    const newOutput = {
...
const messageValidation = computed(() => {
    return message.value.trim().length > 0 && message.value.length <= 1024;
});
...
onMounted(() => {
    // Initialize buttons from WhatsBot format
